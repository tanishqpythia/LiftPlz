  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var y = function() {
      ...
      return r(t2, [{ key: "getStackedSeriesTotals", value: function() {
        ...
        var t3, e2, i2, a2 = this.w.globals, s2 = [], r2 = 0, o2 = [], n2 = 0.1, l2 = 0;
        if (a2.yRange = [], a2.isMultipleYAxis)
          for (var h2 = 0; h2 < a2.minYArr.length; h2++)
            a2.yRange.push(Math.abs(a2.minYArr[h2] - a2.maxYArr[h2])), o2.push(0);
        else
          a2.yRange.push(Math.abs(a2.minY - a2.maxY));
        a2.xRange = Math.abs(a2.maxX - a2.minX), a2.zRange = Math.abs(a2.maxZ - a2.minZ);
        for (var c2 = 0; c2 < a2.yRange.length; c2++)
          s2.push(a2.yRange[c2] / a2.gridHeight);
        if (e2 = a2.xRange / a2.gridWidth, t3 = a2.yRange / a2.gridWidth, i2 = a2.xRange / a2.gridHeight, (r2 = a2.zRange / a2.gridHeight * 16) || (r2 = 1), a2.minY !== Number.MIN_VALUE && 0 !== Math.abs(a2.minY) && (a2.hasNegs = true), a2.isMultipleYAxis) {
          o2 = [];
          for (var d2 = 0; d2 < s2.length; d2++)
            o2.push(-a2.minYArr[d2] / s2[d2]);
        } else
          o2.push(-a2.minY / s2[0]), a2.minY !== Number.MIN_VALUE && 0 !== Math.abs(a2.minY) && (n2 = -a2.minY / t3, l2 = a2.minX / e2);
        return { yRatio: s2, invertedYRatio: t3, zRatio: r2, xRatio: e2, invertedXRatio: i2, baseLineInvertedY: n2, baseLineY: o2, baseLineX: l2 };
    ...
    var _ = function() {
      ...
      return r(t2, [{ key: "niceScale", value: function(t3, e2) {
        ...
        g2 < 1 && (g2 = 1);
        var u2 = g2 * d2;
        r2.config.yaxis[a2].stepSize && (u2 = r2.config.yaxis[a2].stepSize), r2.globals.isBarHorizontal && r2.config.xaxis.stepSize && "datetime" !== r2.config.xaxis.type && (u2 = r2.config.xaxis.stepSize);
        var p2 = u2 * Math.floor(t3 / u2), f2 = u2 * Math.ceil(e2 / u2), b2 = p2;
        if (s2 && o2 > 2) {
    ...
    var wt = function(t2) {
      ...
      return r(s2, [{ key: "draw", value: function(t3, i3) {
        ...
        for (var o2 = this.graphics.group({ class: "apexcharts-bar-series apexcharts-plot-series" }), n2 = 0, l2 = 0, h2 = function(r3, h3) {
          ...
          l2 = S2.y, k2 = S2.barHeight, d3 = S2.yDivision, u2 = S2.zeroW, n2 = S2.x, A2 = S2.barWidth, c3 = S2.xDivision, g2 = S2.zeroH, s3.globals.barHeight = k2, s3.globals.barWidth = A2, a2.barHelpers.initializeStackedXYVars(a2), 1 === a2.groupCtx.prevY.length && a2.groupCtx.prevY[0].every(function(t4) {
            return isNaN(t4);
    ...
    var Ft = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3, i2, a2, s2) {
        ...
        for (var d2 = [], g2 = 0; g2 < t3.length; g2++) {
          ...
          var v2, w2 = b2, k2 = void 0, A2 = w2, S2 = this.zeroY, C2 = this.zeroY;
          S2 = this.lineHelpers.determineFirstPrevY({ i: g2, series: t3, prevY: S2, lineYPosition: 0 }).prevY, "monotonCubic" === o2.config.stroke.curve && null === t3[g2][0] ? p2.push(null) : p2.push(S2), v2 = S2;
          "rangeArea" === l2 && (k2 = C2 = this.lineHelpers.determineFirstPrevY({ i: g2, series: s2, prevY: C2, lineYPosition: 0 }).prevY, f2.push(C2));
          var L2 = { type: l2, series: t3, realIndex: u2, i: g2, x: b2, y: 1, pX: w2, pY: v2, pathsFrom: this._calculatePathsFrom({ type: l2, series: t3, i: g2, realIndex: u2, prevX: A2, prevY: S2, prevY2: C2 }), linePaths: [], areaPaths: [], seriesIndex: a2, lineYPosition: 0, xArrj: x2, yArrj: p2, y2Arrj: f2, seriesRangeEnd: s2 }, P2 = this._iterateOverDataPoints(e(e({}, L2), {}, { iterations: "rangeArea" === l2 ? t3[g2].length - 1 : void 0, isRangeStart: true }));
          if ("rangeArea" === l2) {
            var I2 = this._calculatePathsFrom({ series: s2, i: g2, realIndex: u2, prevX: A2, prevY: C2 }), T2 = this._iterateOverDataPoints(e(e({}, L2), {}, { series: s2, pY: k2, pathsFrom: I2, iterations: s2[g2].length - 1, isRangeStart: false }));
            P2.linePaths[0] = T2.linePath + P2.linePath, P2.pathFromLine = T2.pathFromLine + P2.pathFromLine;
          }
          this._handlePaths({ type: l2, realIndex: u2, i: g2, paths: P2 }), this.elSeries.add(this.elPointsMain), this.elSeries.add(this.elDataLabelsWrap), d2.push(this.elSeries);
        }
        ...
        var e2, i2 = this, a2 = t3.type, s2 = t3.series, r2 = t3.iterations, o2 = t3.realIndex, n2 = t3.i, l2 = t3.x, h2 = t3.y, c2 = t3.pX, d2 = t3.pY, g2 = t3.pathsFrom, u2 = t3.linePaths, p2 = t3.areaPaths, f2 = t3.seriesIndex, b2 = t3.lineYPosition, v2 = t3.xArrj, y2 = t3.yArrj, w2 = t3.y2Arrj, k2 = t3.isRangeStart, A2 = t3.seriesRangeEnd, S2 = this.w, C2 = new m(this.ctx), L2 = this.yRatio, P2 = g2.prevY, I2 = g2.linePath, T2 = g2.areaPath, M2 = g2.pathFromLine, z2 = g2.pathFromArea, X2 = x.isNumber(S2.globals.minYArr[o2]) ? S2.globals.minYArr[o2] : S2.globals.minY;
        r2 || (r2 = S2.globals.dataPoints > 1 ? S2.globals.dataPoints - 1 : S2.globals.dataPoints);
        for (var E2 = function(t4, e3) {
          return e3 - t4 / L2[i2.yaxisIndex] + 2 * (i2.isReversed ? t4 / L2[i2.yaxisIndex] : 0);
        }, Y2 = h2, F2 = S2.config.chart.stacked && !S2.globals.comboCharts || S2.config.chart.stacked && S2.globals.comboCharts && (!this.w.config.chart.stackOnlyBar || "bar" === (null === (e2 = this.w.config.series[o2]) || void 0 === e2 ? void 0 : e2.type)), R2 = 0; R2 < r2; R2++) {
          var H2 = void 0 === s2[n2][R2 + 1] || null === s2[n2][R2 + 1];
          if (S2.globals.isXNumeric) {
            var D2 = S2.globals.seriesX[o2][R2 + 1];
            void 0 === S2.globals.seriesX[o2][R2 + 1] && (D2 = S2.globals.seriesX[o2][r2 - 1]), l2 = (D2 - S2.globals.minX) / this.xRatio;
          } else
            l2 += this.xDivision;
          if (F2)
            if (n2 > 0 && S2.globals.collapsedSeries.length < S2.config.series.length - 1) {
              b2 = this.prevSeriesY[function(t4) {
                for (var e3 = t4, i3 = 0; i3 < S2.globals.series.length; i3++)
                  if (S2.globals.collapsedSeriesIndices.indexOf(t4) > -1) {
                    e3--;
                    break;
                  }
                return e3 >= 0 ? e3 : 0;
            ...
            b2 = this.zeroY;
          H2 ? h2 = E2(X2, b2) : (h2 = E2(s2[n2][R2 + 1], b2), "rangeArea" === a2 && (Y2 = E2(A2[n2][R2 + 1], b2))), v2.push(l2), H2 && "smooth" === S2.config.stroke.curve ? y2.push(null) : y2.push(h2), w2.push(Y2);
          var O2 = this.lineHelpers.calculatePoints({ series: s2, x: l2, y: h2, realIndex: o2, i: n2, j: R2, prevY: P2 }), N2 = this._createPaths({ type: a2, series: s2, i: n2, realIndex: o2, j: R2, x: l2, y: h2, y2: Y2, xArrj: v2, yArrj: y2, y2Arrj: w2, pX: c2, pY: d2, linePath: I2, areaPath: T2, linePaths: u2, areaPaths: p2, seriesIndex: f2, isRangeStart: k2 });
          p2 = N2.areaPaths, u2 = N2.linePaths, c2 = N2.pX, d2 = N2.pY, T2 = N2.areaPath, I2 = N2.linePath, !this.appendPathFrom || "monotoneCubic" === S2.config.stroke.curve && "rangeArea" === a2 || (M2 += C2.line(l2, this.zeroY), z2 += C2.line(l2, this.zeroY)), this.handleNullDataPoints(s2, O2, n2, R2, o2), this._handleMarkersAndLabels({ type: a2, pointsPos: O2, i: n2, j: R2, realIndex: o2, isRangeStart: k2 });
        }
        return { yArrj: y2, xArrj: v2, pathFromArea: z2, areaPaths: p2, pathFromLine: M2, linePaths: u2, linePath: I2, areaPath: T2 };
        ...
        if (Array.isArray(w2.config.stroke.curve) && (A2 = Array.isArray(v2) ? w2.config.stroke.curve[v2[a2]] : w2.config.stroke.curve[a2]), "rangeArea" === e2 && (w2.globals.hasNullValues || w2.config.forecastDataPoints.count > 0) && "monotoneCubic" === A2 && (A2 = "straight"), "monotoneCubic" === A2) {
          ...
          if (C2 && L2.length > 1) {
            ...
            if (p2 += Xt(P2), null === i2[a2][0] ? f2 = p2 : f2 += Xt(P2), "rangeArea" === e2 && y2) {
              ...
              var I2 = l2.slice().reverse(), T2 = d2.slice().reverse(), M2 = I2.map(function(t4, e3) {
                return [I2[e3], T2[e3]];
              }), z2 = Et(M2);
              f2 = p2 += Xt(z2);
            } else
          ...
          null === i2[a2][r2] && (p2 += k2.move(o2, n2), f2 += k2.move(o2, S2)), "stepline" === A2 ? (p2 = p2 + k2.line(o2, null, "H") + k2.line(null, n2, "V"), f2 = f2 + k2.line(o2, null, "H") + k2.line(null, n2, "V")) : "straight" === A2 && (p2 += k2.line(o2, n2), f2 += k2.line(o2, n2)), r2 === i2[a2].length - 2 && (f2 = f2 + k2.line(o2, S2) + k2.move(o2, n2) + "z", "rangeArea" === e2 && y2 ? p2 = p2 + k2.line(o2, c2) + k2.move(o2, c2) + "z" : (x2.push(p2), b2.push(f2)));
        }
